...
- Помимо игр я увлёкся программированием на Basic для ZX-Spectrum (в возрасте 13 лет)
...
- Для восстановления старых знаний и получения новых, я пошёл учиться на курс Нетологии "Java-разработчик с нуля"
